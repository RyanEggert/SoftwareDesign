...
class Player(object):
    ...
    def __init__(self, name, number):
        ...
        self.thetas = []
        self.radii = []
        self.color = None   # Color used for player name text.
        self.image = None
    ...
    def diagwin(self):
        ...
        # Winning diagonal positions. Each list is a win.
